...
// Array to store all EC requests
$ecRequests = [];

// Loop through each department and fetch pending EC requests
foreach ($departments as $dept) {
    ...
    $requestsQuery = "
        SELECT ec_id, student_id, ec_type, ec_description, supporting_document
        FROM ec_requests
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validate input
    if (empty($action) || empty($ecId) || empty($departmentId)) {
        die("Invalid request.");
    }
    ...
    header("Location: ec_requests.php");
    exit();
}
?>
...
<head>
    ...
    <title>Admin - Exceptional Circumstances Requests</title>
    ...
    <div class="dashboard">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav">
                ...
                <li class="active"><a href="ec_requests.php"><i class="fas fa-exclamation-circle"></i> EC Requests</a></li>
        ...
        <div class="main-content">
            ...
            <div class="header">
                <div class="header-left">
                    <h1>Exceptional Circumstances Requests</h1>
                </div>
            ...
            <div class="content">
                <table class="requests-table">
                    ...
                    <tbody>
                        <?php foreach ($ecRequests as $request): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($request['student_id']); ?></td>
                                <td><?php echo htmlspecialchars($request['ec_type']); ?></td>
                                <td><?php echo htmlspecialchars($request['ec_description']); ?></td>
                                <td>
                                    <?php if ($request['supporting_document']): ?>
                                        <a href="<?php echo htmlspecialchars($request['supporting_document']); ?>" target="_blank">View Document</a>
                                    <?php else: ?>
                                        No Document
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <form method="POST" action="ec_requests.php" style="display: inline;">
                                        <input type="hidden" name="ec_id" value="<?php echo htmlspecialchars($request['ec_id']); ?>">
